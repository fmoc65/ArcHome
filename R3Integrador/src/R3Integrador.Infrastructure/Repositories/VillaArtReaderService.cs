...
public class VillaArtReaderService : IVillaArtReader
{
    private const string NomeAba = "VILLA ART - BOUTIQUE";
    ...
    public async Task<List<ProdutoNormalizado>> LerAsync(string caminhoArquivo)
    {
        ...
        Console.WriteLine();
        Console.WriteLine($"[OK] {produtos.Count} produtos Villa Art processados com sucesso.");
